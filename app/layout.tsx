        ...
        <header className="w-full border-b border-slate-800 bg-slate-950/95 px-4 py-4 shadow-lg shadow-slate-950/20 sm:px-6 lg:px-8">
          <div className="mx-auto flex max-w-6xl items-center justify-between gap-4">
            ...
            <nav className="flex items-center gap-3 text-sm text-slate-300">
              <a href="/" className="rounded-full px-3 py-2 transition hover:bg-slate-800 hover:text-white">
                Chat
              </a>
              <a href="/dashboard" className="rounded-full px-3 py-2 transition hover:bg-slate-800 hover:text-white">
                Dashboard
              </a>
            </nav>
          </div>
